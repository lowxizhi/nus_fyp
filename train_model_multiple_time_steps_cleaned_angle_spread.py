...
def parse_args():
    ...
    parser.add_argument("--spread_factor",type=int,default = 8, help = "Spread = pi/spread_factor")
...
spread_factor = arglist.spread_factor
...
model_folder = '/hpctmp/e0323902/angle_spread_experiment/spread_factor_%s/2_stim_batch_size_%s/n_hidden_%s/2_stim_batch_size_%s_n_hidden_%s_acc_%s_seed_%s'%(spread_factor,batch_size_train,n_rnn,batch_size_train,n_rnn,int(accuracy_threshold*100),seed)
if with_noise:
    hp['sigma_rec']=0.05
    hp['sigma_x']=0.01
