...
model_folder += f'2_stim_batch_size_{batch_size_train}/n_hidden_{n_rnn}/2_stim_batch_size_{batch_size_train}_n_hidden_{n_rnn}_acc_{acc}_n_segments_{n_segments}_seed_{seed}'
